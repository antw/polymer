...
describe Flexo::Optimisation, :optimisation => true do
  subject { Flexo::Optimisation }
  ...
  describe '.optimise_file' do
    context 'when given an optimised image' do
      it 'should return 0' do
        Flexo::Optimisation.optimise_file(@optimised_png).should == 0
      end
    end # when given an optimised image

    context 'when given an unoptimised image' do
      it 'should return 0' do
        Flexo::Optimisation.optimise_file(@unoptimised_png).should >= 0
      end
    end # when given an optimised image
  end
  ...
  [ Flexo::Optimisation::PNGOut,
    Flexo::Optimisation::OptiPNG,
    Flexo::Optimisation::PNGCrush ].each do |optimiser|
